<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pack.aspx.cs" Inherits="CRM.Common.Pack" %>
    ...
    <form id="form1" runat="server">
        <table class="table table-bordered">
            ...
            <tr>
                <td style="width: 150px;">
                    <input type="text" placeholder="代码" class="input-xlarge" runat="server" id="txtName" /></td>
                <td style="width: 150px;">
                    <input type="text" placeholder="类型" class="input-xlarge" runat="server" id="txtCode" /></td>
        ...
        <script type="text/javascript">
            ...
            function SetInfo(pack) {
                window.parent.SetPack(pack);
                //window.opener.SetPack(pack);
                //window.close();
            }
