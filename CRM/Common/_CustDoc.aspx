<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="_CustDoc.aspx.cs" Inherits="CRM.Common._CustDoc" %>
            ...
            <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btndown" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"C_PATH") %>' CommandName="down" runat="server" Text="文档下载" CssClass="btn btn-info btn-xs" /></td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
