<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consult_Eval.aspx.cs" Inherits="CRM.Sale_App.Consult_Eval" %>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td><a href="Consult_Eval_View.aspx?ID=<%#DataBinder.Eval(Container.DataItem,"C_ID") %>" title="点击查看"> <%#DataBinder.Eval(Container.DataItem,"C_STL_GRD") %></a></td>
