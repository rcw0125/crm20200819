<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consult_Eval_View.aspx.cs" Inherits="CRM.Sale_App.Consult_Eval_View" %>
...
<body>
    <form id="form1" runat="server">
        <div class="dv_btn">
            <ul>
                <li><a href="Consult_Eval.aspx" class="btn  btn-warning btn-xs">返回</a></li>
            </ul>
        </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <%# DataBinder.Eval(Container.DataItem,"N_CUST_EVAL") %> </td>
                        <td>服务工作评价</td>
                        <td>
                            <input id="txtNum<%# Container.ItemIndex%>" type="text" style="width: 100px" class="num" value='<%# DataBinder.Eval(Container.DataItem,"N_XG_EVAL") %>  '/></td>
                        <td colspan="4">
                            <input id="btnSave" type="button" value="提交评价" onclick='pingjia("<%# DataBinder.Eval(Container.DataItem,"C_ID") %>","<%# Container.ItemIndex%>",this);' class="btn btn-primary btn-xs btn_w60" style='<%# DataBinder.Eval(Container.DataItem,"D_XG_EVAL_DT").ToString ()==""?"display:block": "display:none" %>' />
                        </td>
                    </tr>
        ...
        <script type="text/javascript">
            function pingjia(id, index, btn) {
                ...
                var num = $(txtNum).val();
                var emp = $("#hidUserID").val();
                $.ajax({
                    type: "Post",
                    url: "Consult_Eval_View.aspx/SetEval",
                    data: "{'id':'" + id + "','num':'" + num + "','emp':'" + emp + "'}",
