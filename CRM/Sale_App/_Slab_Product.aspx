<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="_Slab_Product.aspx.cs" Inherits="CRM.Sale_App._Slab_Product" %>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td>
                                    ...
                                    <asp:Literal ID="ltlOrderNo" Visible="false" Text='<%#DataBinder.Eval (Container.DataItem,"C_ORD_NO") %>' runat="server"></asp:Literal>
                                </td>
                                <td><%#DataBinder.Eval (Container.DataItem,"C_LINEWH_LOC_CODE") %></td>
                                <td><%#DataBinder.Eval (Container.DataItem,"C_SLABWH_TIER_CODE") %></td>
