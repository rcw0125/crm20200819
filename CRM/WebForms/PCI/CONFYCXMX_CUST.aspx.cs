...
{
    public partial class CONFYCXMX_CUST : System.Web.UI.Page
    {
        ...
        private void GetList()
        {
            ...
            DataTable dt = tmd_dispatch.GetConFYMX_Statistic_Cust(txtcon.Text, txtcust.Text, txtfyd.Text, txtstlgrd.Text, txtspec.Text, txtbatch.Text, ckkssj, ckjssj, ltlempID.Text).Tables[0];
            ...
            if (Pager1.RecordCount > 0)
            {
                ...
                ltlsumqua.Text = dt.Compute("sum(N_QUA)", "true").ToString();
