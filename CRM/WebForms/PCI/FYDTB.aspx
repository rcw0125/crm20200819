<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FYDTB.aspx.cs" Inherits="CRM.WebForms.PCI.FYDTB" %>
        ...
        <table class="table table-bordered table-condensed">
            <tr>
                <td style="width: 180px">
                    <asp:TextBox ID="txtFYD" placeholder="发运单号" runat="server" Width="100%"></asp:TextBox>
                </td>
                ...
                <td>
                    ...
                    &nbsp;
                         <asp:Button ID="btnSync" CssClass="btn btn-danger btn-xs" runat="server" Text="同步条码" OnClick="btnSync_Click" OnClientClick="_loading(1)"  />
                </td>
            </tr>
        </table>
                ...
                <tbody>
                    <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <asp:LinkButton ID="lblywdh" runat="server" CommandArgument='<%#DataBinder.Eval (Container.DataItem,"fydh") %>' CommandName="xc"><%#DataBinder.Eval (Container.DataItem,"fydh") %></asp:LinkButton>
                                    <asp:Literal ID="lblRecord" Text='<%#DataBinder.Eval (Container.DataItem,"pk_SeZJB_FYD_finished") %>' runat="server" Visible="false"></asp:Literal>
                                </td>
                                <td>
