<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GPFYD.aspx.cs" Inherits="CRM.WebForms.PCI.GPFYD" %>
    ...
    <form id="form1" runat="server">
        <table class="table table-bordered table-condensed">
            <tr>
                <td class="auto-style1">
                    <table class="table table-bordered table-condensed " id="td1">
                        <tr>
                            <td>日期</td>
                            <td>
                                <asp:TextBox runat="server" class="Wdate" ID="txtBegTime" Width="110px" Style="height: 100%;"></asp:TextBox></td>
                            <td>
                                <asp:TextBox runat="server" class="Wdate " ID="txtEndTime" Width="110px" Style="height: 100%;"></asp:TextBox>
                            </td>
                            <td>
                ...
                <td>
                    <table class="table table-bordered table-condensed" id="td2">
                        <tr>
                            <td>
                                <asp:TextBox ID="txtLH" placeholder="炉号" runat="server" Width="110px"></asp:TextBox></td>
                            <td>
                                <asp:TextBox ID="txtKPH" placeholder="开坯号" runat="server" Width="110px"></asp:TextBox></td>
                            <td>
                            ...
                            <td>发运时间 </td>
                            <td>
                                <asp:TextBox runat="server" class="Wdate" ID="txtFYSJ" Style="height: 100%;"></asp:TextBox></td>
                            <td>
            ...
            <tr>
                <td>
                    <div id="div1" style="overflow: auto;">
                        <table  class="table table-bordered table-hover table-condensed tb1" data-toggle="table" data-height="250" style="white-space: nowrap;">
                            <thead>
                                <tr class="info">
                                    <th>合计</th>
                                ...
                                <tr>
                                    ...
                                    <th data-sortable="true" class="red">状态</th>
        ...
        <table class="table table-bordered table-condensed" id="tb3">
            <tr>
                ...
                <td>
                    <asp:Button ID="btncx3" CssClass="btn btn-primary btn-xs" runat="server" Text="查询" OnClientClick="_loading(1)" OnClick="btncx3_Click" /></td>
                <td>
                    <asp:Button ID="Button2" CssClass="btn btn-danger btn-xs" runat="server" Text="取消标记" OnClientClick="_loading(1)" OnClick="Button2_Click" /></td>
                <td>
                    <asp:Button ID="Button1" CssClass="btn btn-primary btn-xs" runat="server" Text="确认" OnClientClick="_loading(1)" OnClick="Button1_Click" /></td>
                <td class="w1">
                    <asp:Button ID="Button4" CssClass="btn btn-danger btn-xs" runat="server" Text="发送NC" OnClientClick="_loading(1)" OnClick="Button4_Click" /></td>
            </tr>
        </table>
        <div style="overflow: auto; width: 100%;" id="div3">
            <table class="table table-bordered table-hover table-condensed " data-toggle="table" data-height="250" style="white-space: nowrap;">
                <thead>
                    <tr class="info">
                        <th>合计</th>
                    ...
                    <tr>
                        ...
                        <th class="red" data-sortable="true">状态</th>
                        <th data-sortable="true">发运单号</th>
                        <th data-sortable="true">车牌号</th>
                        <th data-sortable="true">炉号</th>
                        <th data-sortable="true">开坯号</th>
