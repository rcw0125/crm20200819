<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QTCKTB.aspx.cs" Inherits="CRM.WebForms.PCI.QTCKTB" %>
...
<body onresize="fromsize();">
    <form id="form1" runat="server">
        <table class="table table-bordered table-condensed">
            <tr>
                <td style="width: 180px;">
                    ...
                    <asp:TextBox ID="txtCKDH" placeholder="其他出库单号" runat="server" Width="100%"></asp:TextBox>
                ...
                <tbody>
                    <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <asp:LinkButton ID="lblBatchNo" runat="server" CommandArgument='<%#DataBinder.Eval (Container.DataItem,"ckdh") %>' CommandName="xc"><%#DataBinder.Eval (Container.DataItem,"ckdh") %></asp:LinkButton>
                                </td>
                                <td>
        ...
        <div style="overflow: auto; width: 100%" id="flow2">
            <table id="table2" class="table table-bordered table-hover table-condensed" data-toggle="table" data-height="300" >
                <thead>
                    <tr>
        ...
        <asp:Literal ID="lblCKDH" runat="server" Visible="false"></asp:Literal>
    </form>
