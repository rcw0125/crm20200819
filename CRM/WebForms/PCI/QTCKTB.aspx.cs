...
{
    public partial class QTCKTB : System.Web.UI.Page
    {
        ...
        protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "xc")
            {
                lblCKDH.Text = e.CommandArgument.ToString();
                Detail();
            }
        ...
        private void Detail()
        {
            ...
            {
                DataTable dt = null;
                dt = bll_Interface_FR.GetYWDXQ(lblCKDH.Text, "3", "").Tables[0];
        ...
        protected void btnSync_Click(object sender, EventArgs e)
        {
            ...
            string message = bll_Interface_FR.QTCKDTB(xmlFileName);//需要修改对应路径
            if (message == "1")
            {
                WebMsg.MessageBox("同步完成！");
                Query();
                Detail();
            }
            else
