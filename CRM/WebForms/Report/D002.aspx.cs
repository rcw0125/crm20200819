...
{
    public partial class D002 : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(txtremark.Text))
                {
                    ...
                    if (e.CommandName == "print")
                    {
                        ...
                        if (tmd_dispatchdetails.UpdatePDSet(fyd, user?.Name, "2",txtremark.Text))
                        {
                    ...
                    if (e.CommandName == "print2")
                    {
                        ...
                        if (tmd_dispatchdetails.UpdatePDSet(fyd, user?.Name, "0",txtremark.Text))
                        {
                            WebMsg.MessageBox("设置成功");
                            GetList();
                        }
                ...
                {
                    WebMsg.MessageBox("请补充补打或初始原因说明！");
                }
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            if (dtOrderEx.Rows.Count > 0)
            {
                ...
                dic.Add("C_PDEMP", "最后操作人");
                dic.Add("D_PDTIME", "最后操作时间");
