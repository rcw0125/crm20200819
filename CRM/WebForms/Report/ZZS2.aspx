<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZZS2.aspx.cs" Inherits="CRM.WebForms.Report.ZZS2" %>
        ...
        <table class="table table-bordered table-condensed">
            <tr>
                <td style="text-align: left">
                    &nbsp;&nbsp;<asp:Button ID="btncx" runat="server" Text="查询" style="height:30px;width:80px;font-size:14px; " CssClass="btn btn-primary btn-xs" OnClick="btncx_Click"   OnClientClick="_loading(1);" />
                   ...
                   <div class="btn-group" style="width:280px; display:block; float:left;">  
                     ...
                     <input id="btnprint5" type="button" value="确认状态"  style="width:80px; height:30px;font-size:14px;" onclick="UpdatePrintStatus();" class="btn btn-primary btn-xs" />
                </td>
            </tr>
        </table>
        <table class="table table-bordered table-condensed">
                        ...
                        <table class="table table-bordered table-condensed table-hover text-nowrap"  >
                            <thead>
                                   <tr class="info">
                                    ...
                                    <th>重量：</th>                                   
                                    <th><asp:Literal ID="lstWgt" runat="server"></asp:Literal></th>                                 
                                    <th></th>
                                    <th></th>    
                                    <th></th>
                                    <th></th>      
