...
namespace CRM.WebForms.Report
{
    ...
    public partial class roll_prodcut : System.Web.UI.Page
    {
        ...
        private void BindList()
        {
            ...
            string sfsn = dropsfsn.SelectedValue == "全部" ? "" : dropsfsn.SelectedValue;//是否室内

            DataTable dt = trc_roll_prodcut.GetRollProdcut_SFSN(txtbatchno.Text, txtckcode.Text, txtstlgrd.Text, txtspec.Text, txtmatcode.Text, dropzldj.SelectedItem.Value, dropsalearea.SelectedItem.Value, dropMinArea.SelectedItem.Value, txtcustname.Text, droptsxx.SelectedItem.Value, dropflag.SelectedItem.Value, kssj, jssj, sfsn, txtcon.Text).Tables[0];
            if (dt.Rows.Count > 0)
            {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            if (dtOrderEx.Rows.Count > 0)
            {
                ...
                dic.Add("C_LINEWH_LOC_CODE", "货位");
                dic.Add("C_ISOUT", "是否室内");
