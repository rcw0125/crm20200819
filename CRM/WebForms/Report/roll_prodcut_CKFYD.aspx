<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="roll_prodcut_CKFYD.aspx.cs" Inherits="CRM.WebForms.Report.roll_prodcut_CKFYD" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Literal ID="ltlckcdoe" runat="server" Visible="false"></asp:Literal>
        <asp:Literal ID="ltlfydID" runat="server" Visible="false"></asp:Literal>
