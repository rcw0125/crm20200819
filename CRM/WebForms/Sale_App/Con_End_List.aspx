<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Con_End_List.aspx.cs" Inherits="CRM.WebForms.Sale_App.Con_End_List" %>
...
<asp:ListItem Value="-1">待审</asp:ListItem>
                        <asp:ListItem Value="0">已通知</asp:ListItem>
                ...
                <td>
                    ...
                    <asp:Button ID="btnendcon" runat="server" Text="批准" CssClass="btn btn-danger btn-xs"   OnClick="btnendcon_Click" /></td>
            </tr>
        </table>
