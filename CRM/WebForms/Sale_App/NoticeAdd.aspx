<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeAdd.aspx.cs" Inherits="CRM.Sale_App.NoticeAdd" ValidateRequest="false" %>
    ...
    <table class="table table-bordered table-condensed">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtTitle" runat="server" Height="35px" CssClass="form-control" ></asp:TextBox></td>
            </tr>
         <tr>
                <td style="text-align:right;">
         ...
         <tr>
          <td style="text-align:right;">
                ...
                <td>
                    <asp:Button ID="btnSave" runat="server" Text="提 交" OnClientClick="return Check();"  CssClass="btn btn-primary btn-sm" OnClick="btnSave_Click" />
                     &nbsp; 
