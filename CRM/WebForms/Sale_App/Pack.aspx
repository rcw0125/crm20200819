<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pack.aspx.cs" Inherits="CRM.Sale_App.Pack" %>
...
<body>
    <form id="form1" runat="server">
        <table class="table table-bordered">
            ...
            <tr>
                <td>
                    <input type="text" placeholder="包装类型代码" style="width:100%" runat="server" id="txtName" /></td>
                <td>
                    <input type="text" placeholder="包装类型名称" style="width:100%" runat="server" id="txtCode" /></td>
