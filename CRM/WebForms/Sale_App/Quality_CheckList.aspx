...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openWeb() {
            ...
            openPage("Check_Emp.aspx?ID=" + $("#hidNextSetpID").val(), _w, _h);
        ...
        <div id="div_check" runat="server" style="margin-top: 10px;">
            <table class="table table-bordered">
                ...
                <tr runat="server" id="trNextEmp">
                    <td>下一处理人</td>
                    <td>
                        <asp:TextBox ID="txtC_NEXT_EMP_ID" runat="server" Width="200px" Enabled="false"></asp:TextBox><a href="#" onclick="openWeb();"><span class="glyphicon glyphicon-search"></span></a>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Button ID="btnOk" runat="server" CssClass="btn btn-primary btn-xs" Text="批准" OnClick="btnOk_Click" OnClientClick="return Check();" />&nbsp;&nbsp;
                                    <asp:Button ID="btnNo" runat="server" CssClass="btn btn-primary btn-xs" Text="驳回" OnClick="btnNo_Click" />
                    </td>
                </tr>
            </table>
        </div>
