<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fyd.aspx.cs" Inherits="CRM.WebForms.Sale_App.fyd" %>
...
<head runat="server">
    ...
    <script src="js/jsfyd-1.1.js?ver=1.7"></script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="dv_btn">
            <ul>
                ...
                <li>
                    <input id="Button1" type="button" value="可发运量" class="btn btn btn-success btn-xs" onclick="openWeb(3);" /></li>
        ...
        <table class="table table-bordered table-condensed">
            ...
            <tr>
                ...
                <td>虚拟车号</td>
                <td>
                    <asp:TextBox ID="txtxnch" runat="server" Width="50%"></asp:TextBox>&nbsp;<asp:TextBox ID="txtsjtel" placeholder="司机姓名/电话" Width="45%"  runat="server"></asp:TextBox></td>
                <td>是否包到</td>
                <td><asp:DropDownList ID="dropsfbdj" runat="server">
                        <asp:ListItem Value="0">否</asp:ListItem>
                        <asp:ListItem Value="1">是</asp:ListItem>
                   
                    </asp:DropDownList> &nbsp; <asp:TextBox ID="txtcust_tel" placeholder="客户姓名/电话" Width="120"  runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td>计划号(火运)</td>
                <td>
                    <asp:TextBox ID="txtplanno" Width="40%" runat="server"></asp:TextBox>&nbsp;<a href="javascript:void(0);" onclick="openWeb(4);"><span class="glyphicon glyphicon-search"></span></a>&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="cbx_sftrain" runat="server" Text="生成火运计划" ForeColor="Red"  /></td>
                <td>收货单位(火运)</td>
                <td>
                    <asp:TextBox ID="txtshdw"  Width="100%" runat="server"></asp:TextBox></td>
                <td>专用线(火运)</td>
                <td>
                    <asp:TextBox ID="txtline" Width="100%" runat="server"></asp:TextBox></td>
                <td>开票单位(火运)</td>
                <td>
                    <asp:TextBox ID="txtkpdwcode" runat="server" Width="50"  placeholder="编码">&nbsp;</asp:TextBox>&nbsp;<asp:TextBox ID="txtkpdw" runat="server" Width="120"  placeholder="客户"></asp:TextBox><a href="javascript:void(0);" onclick="openWeb(5);"><span class="glyphicon glyphicon-search"></span></a></td>
            </tr>
        ...
        <div class="table-responsive" style="width: 100%; overflow: auto;">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Label ID="lblcustmoney" runat="server" ForeColor="Red" Text=""></asp:Label>
                            ...
                            <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Literal ID="ltlC_CON_NO" Text='<%#DataBinder.Eval (Container.DataItem,"C_CON_NO")%>' runat="server"></asp:Literal></td>
                                        <td>
                                            <asp:Literal ID="ltlC_STL_GRD" runat="server" Text='<%#DataBinder.Eval (Container.DataItem,"C_STL_GRD")%>'></asp:Literal>  </td>
                                        <td>
                                            <asp:Literal ID="ltlC_SPEC" runat="server" Text='<%#DataBinder.Eval (Container.DataItem,"C_SPEC")%>'></asp:Literal></td>
                                        <td>
                                        ...
                                        <td>
                                            <input id="txtfyzs" runat="server" type="text" class="fyzs" style="width: 100px;" value='<%#DataBinder.Eval (Container.DataItem,"KFYQUA")%>' /></td>
                                        <td>
                                            <input id="txtjhfyl" class="jhfyl" type="text" runat="server" style="width: 100px;" value='<%#DataBinder.Eval (Container.DataItem,"KFYWGT")%>' />
                                        </td>
                                        <td>
                                             <input id="txtaddr" runat="server" type="text" readonly="readonly" style="width: 100px; text-align: center; border: 0; background: transparent; text-align: left"  />
                                             <a href="javascript:void(0);" style="margin-right: 5px;" onclick='openWeb2(5,<%#Container.ItemIndex %>);'><span class="glyphicon glyphicon-search"></span></a>
                                        </td>
                                        <td>
                                             <input id="txtprice" runat="server" type="text"  readonly="readonly" style="width: 100px; text-align: center; border: 0; background: transparent; text-align: left"/>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Literal ID="ltlC_CUST_NAME" Text='<%#DataBinder.Eval (Container.DataItem,"C_CUST_NAME")%>' runat="server"></asp:Literal></td>
                                        <td>
                                        ...
                                        <td>
                                            <input id="txtremark" type="text" maxlength="50" placeholder="只能输入50个字符" runat="server" style="width: 200px; text-align: center; border: 0; background: transparent; text-align: left" /></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                        </tbody>
