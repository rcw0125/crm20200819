<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fydList.aspx.cs" Inherits="CRM.WebForms.Sale_App.fydList" %>
    ...
    <form id="form1" runat="server">
        <table class="table table-bordered table-condensed">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtcust" placeholder="客户/合同号" Style="width: 100%" runat="server"></asp:TextBox></td>
                <td>
        ...
        <table class="table table-bordered table-condensed table-hover" data-toggle="table" data-height="560" style="white-space: nowrap;">
            ...
            <tbody>
                <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td><a href='fydEdit.aspx?ID=<%#DataBinder.Eval (Container.DataItem,"C_ID")%>'>查看</a></td>
