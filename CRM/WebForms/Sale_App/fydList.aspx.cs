...
{
    public partial class fydList : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = tmd_dispatch.GetList(txtsendcode.Text, txtch.Text, txtcust.Text, txtzdr.Text, dropfyfs.SelectedItem.Value, dropsfxc.SelectedItem.Text, txtStart.Value, txtEnd.Value, dropsfbdj.SelectedValue).Tables[0];
            if (dt.Rows.Count > 0)
            {
                dtOrderEx = dt;
