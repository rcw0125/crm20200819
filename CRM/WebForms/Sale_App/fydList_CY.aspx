<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fydList_CY.aspx.cs" Inherits="CRM.WebForms.Sale_App.fydList_CY" %>
...
<head runat="server">
    ...
    <script src="js/jsfydList_CY.js"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="table table-bordered table-condensed table-hover" data-toggle="table" data-height="500">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true">是否线材销售</th>
