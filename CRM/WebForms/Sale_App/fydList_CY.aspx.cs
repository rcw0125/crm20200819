...
{
    public partial class fydList_CY : System.Web.UI.Page
    {
        ...
        {
            Pager1.RecordCount = tmd_dispatch.GetRecordCount(txtsendcode.Text, txtch.Text, txtcust.Text, "", dropfyfs.SelectedItem.Value, dropsfxc.SelectedItem.Text, txtStart.Value, txtEnd.Value, txtdz.Text);
        ...
        {
            rptList.DataSource = tmd_dispatch.GetListByPage(Pager1.PageSize, Pager1.CurrentPageIndex, txtsendcode.Text, txtch.Text, txtcust.Text, "", dropfyfs.SelectedItem.Value, dropsfxc.SelectedItem.Text, txtStart.Value, txtEnd.Value, txtdz.Text);
            rptList.DataBind();
        }
