<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fyd_twc.aspx.cs" Inherits="CRM.WebForms.Sale_App.fyd_twc" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="table table-bordered table-condensed">
            ...
            <tr>
                ...
                <td>是否包到</td>
                <td><asp:DropDownList ID="dropsfbdj" runat="server" Width="50px">
