...
namespace NF.BLL
{
    ...
    /// 发运日计划
    /// </summary>
    public partial class Bll_TMP_PLAN
    {
        private readonly Dal_TMP_PLAN dal = new Dal_TMP_PLAN();
        public Bll_TMP_PLAN()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 获得数据列表
        /// </summary>
        public List<Mod_TMP_PLAN> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Mod_TMP_PLAN> DataTableToList(DataTable dt)
        {
            List<Mod_TMP_PLAN> modelList = new List<Mod_TMP_PLAN>();
        ...
        {
            return dal.GetPlanList(C_CON_NO);
        }
