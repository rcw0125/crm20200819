...
namespace NF.DAL
{
    ...
    public abstract class DbHelperOra
    {
       ...
       // public static string connectionString = "DATA SOURCE=192.168.2.177/ORCLPDB;PASSWORD=xgcap;PERSIST SECURITY INFO=True;USER ID=XGCAP";
        public static string connectionString = "DATA SOURCE=192.168.48.70/ORCLPDB;PASSWORD=xgcap;PERSIST SECURITY INFO=True;USER ID=XGCAP";
        ...
        public static int RunProcedure(string storedProcName, IDataParameter[] parameters)
        {
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                ...
                int.TryParse(result?.ToString(), out int tst);
