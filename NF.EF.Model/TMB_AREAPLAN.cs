...
namespace NF.EF.Model
{
    ...
    public partial class TMB_AREAPLAN
    {
        ...
        public Nullable<decimal> N_WGT_JK { get; set; }
        public Nullable<short> N_SORT { get; set; }
        public Nullable<decimal> N_WGT_PT { get; set; }
        public Nullable<decimal> N_WGT_GS { get; set; }
        public Nullable<decimal> N_WGT_JP { get; set; }
    }
}
