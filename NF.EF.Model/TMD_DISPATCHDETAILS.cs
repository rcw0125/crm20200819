...
namespace NF.EF.Model
{
    ...
    public partial class TMD_DISPATCHDETAILS
    {
        ...
        public Nullable<decimal> N_JWGT { get; set; }
        ...
        public string C_PLAN_CODE { get; set; }
        ...
        public string C_ORDERPK { get; set; }
        public string C_CUSTNO { get; set; }
        public Nullable<long> N_FYZS { get; set; }
        public Nullable<decimal> N_FYWGT { get; set; }
        public string C_SEND_STOCK_PK { get; set; }
        public string C_SEND_STOCK_CODE { get; set; }
        public string C_ZZS_NO { get; set; }
