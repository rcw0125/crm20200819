...
namespace NF.EF.Model
{
    ...
    public partial class TRP_PLAN_ITEM_LOG
    {
        ...
        public Nullable<short> N_PROD_WGT { get; set; }
        public Nullable<short> N_WARE_WGT { get; set; }
        public Nullable<short> N_WARE_OUT_WGT { get; set; }
        public Nullable<short> N_FLAG { get; set; }
        public Nullable<short> N_ISSUE_WGT { get; set; }
        ...
        public Nullable<short> N_GROUP_WGT { get; set; }
