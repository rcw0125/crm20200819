...
namespace NF.Framework
{
    public class Encrypt
    {
        ...
        public static string Encode(string encryptString, string encryptKey = "xgcrm001")
        {
        ...
        public static string Decode(string decryptString, string decryptKey = "xgcrm001")
        {
            try
            {
